...
import { vary, append } from '../lib/deps/vary/index.js';
...
describe('vary.append(header, field)', function () {
  describe('arguments', function () {
    describe('header', function () {
      it('should be required', function () {
        assert.throws(append.bind(), /header.*required/)
      })

      it('should be a string', function () {
        assert.throws(append.bind(null, 42), /header.*required/)
      })
    })

    describe('field', function () {
      it('should be required', function () {
        assert.throws(append.bind(null, ''), /field.*required/)
      })
  ...
  describe('when field is array', function () {
    ...
    it('should handle existing values', function () {
      assert.strictEqual(append('Accept, Accept-Encoding', ['origin', 'accept', 'accept-charset']), 'Accept, Accept-Encoding, origin, accept-charset')
    })
  })
})
