...
import unpipe from '../lib/deps/unpipe/index.js';
...
describe('unpipe(stream)', function () {
  ...
  describe('stream with unpipe support', function () {
    ...
    it.skip('should unpipe single destination', function (done) {
      var pipes = 0
      var stream = new SlowReadStream()
    ...
    it.skip('should not remove custom close events', function (done) {
      var pipes = 0
      var stream = new SlowReadStream()
      var dest = new SlowWriteStream()
  ...
  describe('stream without unpipe support', function () {
    ...
    it.skip('should not remove custom data events', function (done) {
      var pipes = 0
      var stream = new SlowOldStream()
      var dest = new SlowWriteStream()
