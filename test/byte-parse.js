...
import { parse } from '../lib/deps/bytes/index.js';
...
describe('Test byte parse function', function(){
  ...
  it('Should parse raw number', function(){
    ...
    assert.strictEqual(parse(1), 1);
    assert.strictEqual(parse(10.5), 10.5);
  });
  ...
  it('Should parse PB', function(){
    assert.equal(parse('1pb'), 1 * Math.pow(1024, 5));
    assert.equal(parse('1PB'), 1 * Math.pow(1024, 5));
    assert.equal(parse('1Pb'), 1 * Math.pow(1024, 5));
    assert.equal(parse('1pB'), 1 * Math.pow(1024, 5));

    assert.equal(parse('0.5pb'), 0.5 * Math.pow(1024, 5));
    assert.equal(parse('0.5PB'), 0.5 * Math.pow(1024, 5));
    assert.equal(parse('0.5Pb'), 0.5 * Math.pow(1024, 5));
    assert.equal(parse('0.5pB'), 0.5 * Math.pow(1024, 5));

    assert.equal(parse('1.5pb'), 1.5 * Math.pow(1024, 5));
    assert.equal(parse('1.5PB'), 1.5 * Math.pow(1024, 5));
    assert.equal(parse('1.5Pb'), 1.5 * Math.pow(1024, 5));
    assert.equal(parse('1.5pB'), 1.5 * Math.pow(1024, 5));
  });
  ...
  it('Should drop partial bytes', function(){
    assert.equal(parse('1.1b'), 1);
    assert.equal(parse('1.0001kb'), 1024);
  });
