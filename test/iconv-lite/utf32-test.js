import iconv from '../../lib/deps/iconv-lite/index.js';
...
//     it.skip('encodes basic strings correctly', function() {
//         assert.equal(iconv.encode(testStr, 'UTF32-LE').toString('hex'), utf32leBuf.toString('hex'));
//     });

//     it.skip('decodes basic buffers correctly', function() {
//         assert.equal(iconv.decode(utf32leBuf, 'ucs4le'), testStr);
//     });

//     it.skip('decodes uneven length buffers with no error', function() {
//         assert.equal(iconv.decode(Buffer.from([0x61, 0, 0, 0, 0]), 'UTF32-LE'), 'a');
//     });

//     it.skip('handles invalid surrogates gracefully', function() {
