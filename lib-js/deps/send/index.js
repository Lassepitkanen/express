 ...
 * @public
 */
export function send(req, path, options) {
...
function SendStream (req, path, options) {
  ...
  this._acceptRanges = opts.acceptRanges !== void 0
    ? Boolean(opts.acceptRanges)
    : true;

  this._cacheControl = opts.cacheControl !== void 0
    ? Boolean(opts.cacheControl)
    : true;

  this._etag = opts.etag !== void 0
    ? Boolean(opts.etag)
    : true;

  this._dotfiles = opts.dotfiles !== void 0
    ? opts.dotfiles
    : 'ignore';
  ...
  this._extensions = opts.extensions !== void 0
    ? normalizeList(opts.extensions, 'extensions option')
    : [];

  this._immutable = opts.immutable !== void 0
    ? Boolean(opts.immutable)
    : false;

  this._index = opts.index !== void 0
    ? normalizeList(opts.index, 'index option')
    : ['index.html'];

  this._lastModified = opts.lastModified !== void 0
 ...
 * @api public
 */
SendStream.prototype.etag = function etag (val) {
 ...
 * @api public
 */
SendStream.prototype.hidden = function hidden (val) {
...
SendStream.prototype.from = SendStream.prototype.root;

SendStream.prototype.root = SendStream.prototype.root;
